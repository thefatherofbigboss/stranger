...
export const metadata: Metadata = {
    title: "Stranger Mingle Mumbai - Meetups, Events & Making Friends in Mumbai",
    description: "Join curated stranger meetups and events in Mumbai. Meet new people in Viman Nagar, Baner, Hinjewadi, and Koregaon Park. Small groups. Safe. Fun.",
    alternates: {
...
export default async function mumbaiCityPage() {
    ...
    const popularAreas = [
        ...
        { name: "Koregaon Park", description: "The cultural and nightlife hub of Mumbai." },
        { name: "Baner / Balewadi", description: "The upscale residential and IT corridor." },
        { name: "Hinjewadi", description: "The massive IT hub where most young Mumbaikars work." }
    ];
        ...
        <div className="min-h-screen bg-white selection:bg-blue-500/30">
            ...
            <section className="relative w-full pt-32 pb-20 sm:pt-40 sm:pb-32 flex flex-col items-center text-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Friends in Mumbai having fun"
                        fill
                ...
                <div className="relative z-10 w-full max-w-4xl mx-auto px-4">
                    <span className="px-4 py-2 rounded-full bg-blue-600/20 backdrop-blur-md border border-blue-400/30 text-sm font-medium text-blue-300 inline-block mb-6 uppercase tracking-wider">
                        Mumbai's #1 Community for Strangers
                    </span>
                    ...
                    <p className="text-xl text-white/90 max-w-2xl mx-auto mb-10 leading-relaxed">
                        Tired of loneliness in the IT hub? We organize safe, curated meetups in Mumbai for people who want to skip the small talk and build real connections.
                    </p>
            ...
            <section className="py-12 border-b border-gray-100 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8">
                    <div className="text-center">
                        ...
                        <div className="text-sm text-gray-500 uppercase tracking-widest font-medium">Mumbaikars</div>
                    </div>
                    <div className="text-center">
            ...
            <section className="py-24 bg-gray-900 text-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 relative">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-4xl font-bold mb-6">Find Your Tribe in Your Part of Mumbai</h2>
                        ...
                        <div className="relative aspect-square">
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-blue-600 p-8 rounded-3xl shadow-2xl hidden md:block">
                                ...
                                <p className="text-blue-100">Partnered in Mumbai</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Mumbai Needs Stranger Mingle</h2>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">Modern life in Mumbai can be lonely. We build the bridges you need.</p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-12">
                    ...
                    <div className="text-center p-8">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            We pick the best cafes and spaces in Mumbai to ensure you're comfortable and the vibes are just right.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <section className="py-24 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4">
                        <div className="flex justify-between items-end mb-12">
                            <div>
                                <h2 className="text-4xl font-bold text-gray-900 mb-4">Mumbai City Guides</h2>
                                <p className="text-lg text-gray-600">Tips and stories for people making friends in Mumbai.</p>
                            </div>
            ...
            <section className="py-24 max-w-5xl mx-auto px-4">
                <div className="bg-linear-to-br from-blue-600 to-purple-700 rounded-[3rem] p-12 sm:p-20 text-center relative overflow-hidden">
                    <div className="relative z-10">
                        <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6">Ready to Mingle in Mumbai?</h2>
                    ...
                    __html: JSON.stringify([
                        {
                            ...
                            "description": "City homepage for Stranger Mingle Mumbai events and community.",
